...
@Component({
  ...
  templateUrl: './mm2h-dashboard.component.html',
  styleUrls: ['./mm2h-dashboard.component.css']
})
export class Mm2hDashboardComponent implements OnInit {
...
displayedColumns: string[] = [
  ...
  // CALL REST API HERE.
  loadProperties() {
    const propertyType = "mm2h";   // <-- CHANGE IF NEEDED  
